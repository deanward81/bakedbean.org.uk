...
(function (root, factory) {
  ...
  var globalObject = typeof global !== 'undefined' ? global : this||window,
    ...
    queryElementAll = function (selector, parent) {
      var lookUp = parent ? parent : DOC;
      return typeof selector === 'object' ? selector : lookUp.querySelectorAll(selector);
    },
  ...
  var Collapse = function( element, options ) {
    ...
    var accordion = null, collapse = null, self = this, 
      ...
      getTarget = function() {
        var href = element.href && element[getAttribute]('href'),
          ...
          id = href || ( parent && (parent.charAt(0) === '#' || parent.charAt(0) === '.') ) && parent;
        return id && queryElementAll(id);
      };
    
    // public methods
    this.toggle = function(e) {
      e[preventDefault]();
      if (!collapse.some(function (e) { return hasClass(e, showClass); })) { self.show(); }
      else { self.hide(); }
    };
    this.hide = function () {
      if (collapse.some(function (e) { return e[isAnimating]; })) return;
      collapse.forEach(function (e) {
        closeAction(e, element);
      });
    ...
    this.show = function() {
      ...
      if (!collapse.some(function (e) { return e[isAnimating]; }) || activeCollapse && !activeCollapse[isAnimating] ) {
        if ( activeElement && activeCollapse !== collapse ) {
          closeAction(activeCollapse,activeElement); 
          addClass(activeElement,collapsed);
        }
        collapse.forEach(function (e) {
          openAction(e, element);
        });
    ...
    collapse = Array.prototype.slice.call(getTarget());
    collapse.forEach(function (e) {
      e[isAnimating] = false;  // when true it will prevent click handlers    
    })
